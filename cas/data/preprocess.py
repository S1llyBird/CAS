...
from cas.data.templates import get_template, list_templates
...
def process_single_row(row, current_split_name, row_index, system_content, user_content_prefix, prompt_template):
    """
    Process a single row of data for the CAS agent format.
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Download and process QA datasets from RUC-NLPIR/FlashRAG_datasets for CAS.",
    ...
    parser.add_argument(
        "--template",
        default="cas",
        help="Prompt template to use (default: cas). Use --list_templates to see available templates.",
    )
    parser.add_argument(
